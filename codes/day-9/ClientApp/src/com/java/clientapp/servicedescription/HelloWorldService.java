 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://services.helloworldserviceapp.java.com/", wsdlLocation = "http://localhost:9898/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://services.helloworldserviceapp.java.com/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9898/hellows?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://services.helloworldserviceapp.java.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.helloworldserviceapp.java.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
